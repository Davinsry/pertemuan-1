                    ...
                    <form action="{{ route('product.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="category_id" name="category_id"
                                    class="w-full px-4 py-2.5 rounded-lg border {{ $errors->has('category_id') ? 'border-red-500 ring-red-200' : 'border-gray-300 dark:border-gray-600' }} bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-4 focus:ring-indigo-100 focus:border-indigo-500 outline-none transition">
